...
public class CloudFileUtil {
	...
	public InputStream download(String tfileId, String ext) {
		...
		ResponseEntity<byte[]> response = restTemplate.exchange(ApiClient.GET_RESOURCE_FILE, HttpMethod.GET, entity,
				byte[].class, tfileId);
	...
	public String upload(InputStream is, String json) {
		...
		form.add("file", new MultipartFileResource(is, "test.png"));
		form.add("json", json);
