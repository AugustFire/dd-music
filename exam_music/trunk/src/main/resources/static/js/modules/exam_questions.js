...
/*	 审核记录*/
	...
	/*单个驳回*/
		...
		$("body").on("click","#unpass-all",function(){
			var id = "";
			/*获取已勾选选项id*/
			$(".layui-table").find(".layui-form-checked").each(function(){
...
/*	 设置考卷获取数据*/
	...
	$("#preview-content").find(".layui-tab-title").find("li:eq(0)").addClass("layui-this");
	$("#preview-content").find(".layui-tab-content").find(".layui-tab-item:eq(0)").addClass("layui-show"); 
