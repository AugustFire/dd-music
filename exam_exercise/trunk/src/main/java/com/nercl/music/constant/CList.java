...
public interface CList {
     ...
     * AJax请求的返回码
     */
    interface ReturnConstant
    {
        /**
         * 参数错误 -2
         */
        Integer RETURN_FAIL_PARAMTER = -2;

        /**
         * 服务异常 -1
         */
        Integer RETURN_FAIL_SERVICE = -1;

        /**
         * 失败 0
         */
        Integer RETURN_FAIL = 0;

        /**
         * 成功 1
         */
        Integer RETURN_SUCCESS = 1;

        /**
         * 数据已存在 2
         */
        Integer RETURN_DATA_DUPLICATE = 2;

        /**
         * 数据不存在 3
         */
        Integer RETURN_DATA_NULL = 3;
